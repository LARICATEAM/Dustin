...
print("::Dustin::")
local RunBot = io.open("Dustin", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Dustin
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Dustin.lua
wget "https://raw.githubusercontent.com/LARICATEAM/Dustin/master/Dustin.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Dustin.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Dustin -X kill
screen -S Dustin ./Dustin
done
]])
RunTs:close()
end
